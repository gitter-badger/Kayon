...
public class Adjective implements Translatable, Vocab
{
    ...
    public boolean allows(@NotNull ComparisonDegree comparisonDegree)
    {
        ...
        {
            case POSITIVE: return this.allowsPositive();
            case COMPARATIVE: return this.allowsComparative();
            case SUPERLATIVE: return this.allowsSuperlative();
    ...
    public void setAllows(@NotNull ComparisonDegree comparisonDegree, boolean allows)
    {
        ...
        switch (comparisonDegree)
        {
            case POSITIVE: this.setAllowsPositive(allows); break;
            case COMPARATIVE: this.setAllowsComparative(allows); break;
            case SUPERLATIVE: this.setAllowsSuperlative(allows); break;
        }
    }
    //endregion
                                        ...
                                        for (AdjectiveForm form : equalForms)
                                            if (!form.equals(new AdjectiveForm(comparisonDegree, caze, count, gender)))
                                                try
                                                {
                                                    ...
                                                    putDeclinedFormIfAbsent(form.getComparisonDegree(), form.getCase(), form.getCount(), form.getGender(), definedFormOrNull);
